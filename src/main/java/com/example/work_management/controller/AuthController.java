...
import com.example.work_management.response.TokenResponse;
import com.example.work_management.model.ERole;
...
import com.example.work_management.payload.SignUpRequest;
import com.example.work_management.reponsitory.RoleRepository;
...
public class AuthController {
    ...
    @PostMapping("/login")
    public ResponseBase login(@RequestBody UserRequest userRequest) throws Exception {
